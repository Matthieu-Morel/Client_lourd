...
public class VueModifierProduit {
    ...
    public VueModifierProduit(JDialog jDialog, VueProduits parentView, Produit product, ArrayList<Fournisseur> providers, int indexRow) {
        ...
        Fournisseur providerProduct = product.getProvider();
