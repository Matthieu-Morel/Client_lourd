...
public class VueSupprimerProduit {
    private JDialog frame;
    private JLabel labelDelete;
    private JButton btnCancel;
    private JButton btnValidate;

    public VueSupprimerProduit(JDialog jDialog, VueProduits parentView, Produit product, int row) {
        ...
        ProduitControleur controller = new ProduitControleur(this, produitDAO, parentView, product, row);
