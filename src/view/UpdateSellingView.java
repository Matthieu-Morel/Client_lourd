...
public class UpdateSellingView {
    ...
    public UpdateSellingView(JDialog jDialog, SellingsView parentView, ArrayList<Product> products, Selling selling, int indexRow) {
        ...
        Product productSelling = selling.getProduct();
